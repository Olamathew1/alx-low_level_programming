...
/**
 * check_elf - This Checks for an ELF file.
 * @e_ident: A pointer to an array of an ELF magic numbers.
 *
...
/**
 * print_magic -This will Prints the magic numbers of ELF header.
 * @e_ident: A pointer to an array of the ELF magic numbers.
 *
 * Description: Magic numbers are divided by spaces.
 */
...
/**
 * print_class - Prints the specification of an ELF header.
...
/**
 * close_elf - This will closes anELF file.
...
/**
 * main - This will displays the information in the
